...
/// this behavior. Windows users may need to specify the location of the header
/// below
...
/// accessible
/// \details If defined, declarations of not yet implemented functions will be
/// accessible. Uncomment the line or pass the defined value at compile time
...
namespace ai{
    ...
    /// row one after another in a line
    /// \param matrix Matrix to fill
    /// \param vector Vector storing the values
...
/// \} End of Main Group
    ...
    namespace ai{
        /// Still looking for a good cross-platform solution for C++11
